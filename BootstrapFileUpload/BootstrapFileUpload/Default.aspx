<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="BootstrapFileUpload.Default" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>上传控件测试</title>
    <link rel="stylesheet" href="BootstrapFileUpload/css/bootstrap.css"/>
    <link rel="stylesheet" href="BootstrapFileUpload/css/font-awesome.css"/>

    <!--fonts-->
    <link rel="stylesheet" href="BootstrapFileUpload/css/ace-fonts.css"/>
    <link rel="stylesheet" href="BootstrapFileUpload/css/ace.css"/>

    <!--[if lte IE 9]>
		  <link rel="stylesheet" href="BootstrapFileUpload/css/ace-ie.css" />
	<![endif]-->
</head>
<body>
    <div class="main-container">
	   ...
	   <div class="row">
		...
		<div class="center" style="width:400px; margin:12px;">
			...
			<!-- our form -->
			<form id="myform" method="post" action="FileUploadHandler.ashx">
	...
	<script type="text/javascript">
	    window.jQuery || document.write("<script src='BootstrapFileUpload/js/jquery.js'>" + "<" + "/script>");
	</script>
	<!-- <![endif]-->
	<!--[if IE]>
	<script type="text/javascript">
		window.jQuery || document.write("<script src='BootstrapFileUpload/js/jquery1x.js'>"+"<"+"/script>");
	</script>
	<![endif]-->
		
	<!-- ace scripts -->
	<script src="BootstrapFileUpload/js/bootstrap.js"></script>
	<script src="BootstrapFileUpload/js/ace-elements.js"></script>
	<script src="BootstrapFileUpload/js/ace.js"></script>
