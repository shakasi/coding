...
{
    public partial class ServiceShaka : ServiceBase
    {
        ...
        {
            _log.Info("ServiceShaka : 开始OnStart");
            ...
            _log.Info("ServiceShaka : 结束OnStart");
        }

        protected override void OnStop()
        {
            _t.Enabled = false;
            _log.Info("ServiceShaka:OnStop");
        }

        protected override void OnContinue()
        {
            _t.Enabled = true;
            _log.Info("ServiceShaka:OnContinue");
        }

        protected override void OnPause()
        {
            _t.Enabled = false;
            _log.Info("ServiceShaka:OnPause");
        }
    }
}