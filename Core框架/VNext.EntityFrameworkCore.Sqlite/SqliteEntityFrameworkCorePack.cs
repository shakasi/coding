...
namespace VNext.Entity.Sqlite
{
    ...
    public class SqliteEntityFrameworkCorePack : EntityFrameworkCorePackBase
    {
        ...
        public override IServiceCollection AddServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISqlExecutor, SqliteDapperSqlExecutor>();
        ...
        {
            bool? hasSqlite = provider.GetVNextOptions()?.DbContexts?.Values.Any(m => m.DatabaseType == DatabaseType.Sqlite);
