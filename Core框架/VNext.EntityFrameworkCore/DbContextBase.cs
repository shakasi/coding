...
namespace VNext.Entity
{
    ...
    public abstract class DbContextBase : DbContext, IDbContext
    {
        ...
        private readonly DbContextOption _dbOptions;
            ...
            : base(options)
        {
            ...
            _dbOptions = serviceProvider?.GetVNextOptions()?.DbContexts?.Values.FirstOrDefault(m => m.DbContextType == GetType());
        ...
        public override int SaveChanges()
        {
            ...
            var auditEntities = auditEntityProvider?.GetAuditEntities(this).ToList();
