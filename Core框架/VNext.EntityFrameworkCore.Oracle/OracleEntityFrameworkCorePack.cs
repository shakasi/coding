...
namespace VNext.Entity.Oracle
{
    ...
    public class OracleEntityFrameworkCorePack : EntityFrameworkCorePackBase
    {
        ...
        public override IServiceCollection AddServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ISqlExecutor, OracleDapperSqlExecutor>();
        ...
        {
            bool? hasOracle = provider.GetVNextOptions()?.DbContexts?.Values.Any(m => m.DatabaseType == DatabaseType.Oracle);
