...
namespace VNext.Entity
{
    public partial class Compiler
    {
        ...
        private SqlBuilder TransformAggregateQuery(SqlBuilder query)
        {
        ...
        protected virtual SqlResult CompileRaw(SqlBuilder query)
        {
            SqlResult ctx;
        ...
        public virtual SqlResult Compile(SqlBuilder query)
        {
        ...
        public virtual SqlResult Compile(IEnumerable<SqlBuilder> queries)
        {
        ...
        protected virtual SqlResult CompileSelectQuery(SqlBuilder query)
        {
            var ctx = new SqlResult
            {
                Query = query.Clone(),
        ...
        private SqlResult CompileDeleteQuery(SqlBuilder query)
        {
            var ctx = new SqlResult
            {
                Query = query
        ...
        private SqlResult CompileUpdateQuery(SqlBuilder query)
        {
            var ctx = new SqlResult
            {
                Query = query
        ...
        protected virtual SqlResult CompileInsertQuery(SqlBuilder query)
        {
            var ctx = new SqlResult
            {
                Query = query
        ...
        protected virtual SqlResult CompileCteQuery(SqlResult ctx, SqlBuilder query)
        {
