...
namespace VNext.Entity
{
    ...
    {
        public SqlBuilder AsInsert(object data, bool returnId = false)
        {
        ...
        public SqlBuilder AsInsert(IEnumerable<string> columns, IEnumerable<object> values)
        {
        ...
        public SqlBuilder AsInsert(IEnumerable<KeyValuePair<string, object>> values, bool returnId = false)
        {
        ...
        /// <returns></returns>
        public SqlBuilder AsInsert(IEnumerable<string> columns, IEnumerable<IEnumerable<object>> rowsValues)
        {
            var columnsList = columns?.ToList();
        ...
        /// <returns></returns>
        public SqlBuilder AsInsert(IEnumerable<string> columns, SqlBuilder query)
        {
            Method = "insert";
