...
namespace VNext.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <param name="options">匹配规则</param>
        /// <param name="isContains">是否包含，否则全匹配</param>
        /// <returns>如果正则表达式找到匹配项，则为 true；否则，为 false</returns>
        public static bool IsMatch(this string value, string pattern, RegexOptions options = RegexOptions.None, bool isContains = true)
        {
            if (value == null)
            {
                return false;
            ...
            return isContains
                ...
                : Regex.Match(value, pattern, options).Success;
        }
        ...
        public static bool StartsWith(this string source, params string[] array)
        {
        ...
        {
            Guid.TryParse(source, out Guid guid);
            return guid;
        }
        ...
        {
            bool.TryParse(source, out bool reValue);
            return reValue;
        }
        ...
        {
            byte.TryParse(source, out byte reValue);
            return reValue;
        }
        ...
        {
            short.TryParse(source, out short reValue);
            return reValue;
        }
        ...
        {
            Int32.TryParse(source, out int reValue);
            return reValue;
        }
        ...
        {
            return int.TryParse(source, out int reValue) ? reValue : defaultValue;
        }

        /// <summary>转化为int64型</summary>
        public static long ToInt64(this string source)
        {
            long.TryParse(source, out long reValue);
            return reValue;
        }
        ...
        {
            float.TryParse(source, out float reValue);
            return reValue;
        }
        ...
        {
            double.TryParse(source, out double reValue);
            return reValue;
        }
        ...
        {
            decimal.TryParse(source, out decimal reValue);
            return reValue;
        }
        ...
        /// 从头截取指定长度 后默认加  ...
        /// </summary>
        /// <param name="word">自已</param>
        /// <param name="subLength">长度</param>
        /// <param name="afterWord">默认最后加...</param>
        /// <returns></returns>
        public static string ToShowLimitLength(this string word, int subLength, string afterWord = "...")
        {
            if (word != null && word.Length > subLength)
            {
                return word.Substring(0, subLength) + afterWord;
            }
            else
            {
                return word;
        ...
        /// 字符串转枚举
        /// </summary>
        public static T ToEnum<T>(this string enumStr, T defaultValue = default(T)) where T : struct, IComparable, IFormattable
        {
            T convertedValue = defaultValue;
            if (!string.IsNullOrWhiteSpace(enumStr) && !Enum.TryParse(enumStr.Trim(), true, out convertedValue))
