...
namespace VNext.AspNetCore
{
    ...
    /// </summary>
    public class HttpContextScopeServiceResolver : IScopeServiceResolver
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        /// <summary>
        /// 初始化一个<see cref="HttpContextScopeServiceResolver"/>类型的新实例
        /// </summary>
        public HttpContextScopeServiceResolver(IHttpContextAccessor httpContextAccessor)
        {
